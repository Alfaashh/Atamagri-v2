              ...
              <>
                ...
                <Tabs defaultValue="sensors" className="mb-6">
                  ...
                  <TabsContent value="sensors" className="space-y-6">
                    ...
                    {/* Decision Support Card (Hanya muncul jika ada kondisi penting) */}
                    {(() => {
                      ...
                      const irrigationTrigger = soil < 25 || (rain === 0 && temp > 32)
                      const sprayingTrigger = rain > 0
                      const heatTrigger = temp > 34 && light > 600

                      const hasAnyDecision = irrigationTrigger || sprayingTrigger || heatTrigger
                        ...
                        <Card className="border-0 bg-white shadow-sm">
                          <CardHeader>
                            <CardTitle className="flex items-center space-x-2">
                              ...
                              <span>Rekomendasi Tindakan Berbasis Kondisi Saat Ini</span>
                            </CardTitle>
                            <CardDescription>
                              Menampilkan hanya rekomendasi yang perlu diperhatikan sekarang (reaktif terhadap data sensor).
                            </CardDescription>
                          </CardHeader>
                          <CardContent>
                            <div className="grid md:grid-cols-2 gap-4 text-sm">
                              {/* Penyiraman / Irigasi - hanya jika perlu */}
                              {irrigationTrigger && (
                                <div className="p-3 rounded-lg bg-green-50">
                                  ...
                                  <p className="text-xs text-gray-500 mb-1">
                                    Kelembaban tanah: {soil.toFixed(1)}% • Suhu: {temp.toFixed(1)}°C • Hujan:{" "}
                                    {rain.toFixed(1)} mm
                                  </p>
                                  <p className="text-gray-700">
                                    {soil < 15
                                      ? "Tanah sangat kering, jadwalkan penyiraman sesegera mungkin pada petak prioritas."
                                      : "Tanah mulai mengering dan tidak ada hujan, rencanakan irigasi dalam 1–2 jam ke depan."}
                                  </p>
                                </div>
                              )}

                              {/* Penyemprotan - hanya kalau hujan */}
                              {sprayingTrigger && (
                                <div className="p-3 rounded-lg bg-amber-50">
                                  ...
                                  <p className="text-xs text-gray-500 mb-1">
                                    Intensitas hujan: {rain.toFixed(1)} mm • Kelembaban: {air.toFixed(1)}%
                                  </p>
                                  <p className="text-gray-700">
                                    Sedang/turun hujan, hentikan sementara aktivitas penyemprotan agar larutan tidak
                                    terbuang dan ulangi saat kondisi lebih kering.
                                  </p>
                                </div>
                              )}
                              ...
                              {heatTrigger && (
                                <div className="p-3 rounded-lg bg-red-50">
                                  ...
                                  <p className="text-gray-700">
                                    ...
                                    pekerjaan berat ke pagi/sore, tambah naungan di area sensitif, dan pastikan pekerja
                                    cukup hidrasi.
                                  </p>
                                </div>
                              )}
